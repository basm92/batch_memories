...
response = dashscope.MultiModalConversation.call(
    ...
    model='qwen3-vl-235b-a22b-instruct',  # In this example, qwen3-vl-plus is used. You can change the model name as needed. For a list of models, see https://www.alibabacloud.com/help/model-studio/getting-started/models.
    messages=messages)

#print(response["output"]["choices"][0]["message"].content[0]["text"])

# A model that performed very well is qwen3-vl-235b-a22b-instruct