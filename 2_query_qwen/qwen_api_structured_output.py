...
messages = [
    {
        ...
        "content": [
            ...
            {"type": "text", 
                "text": """
                Transcribe this inheritance document to .json with the following keys: name, date of death, total assets, total liabilities and net wealth, followed by a description of all assets, all liabilities and their values.
The output should be in the following JSON format:
                {
  "name": "string",
  "date_of_death": "YYYY-MM-DD",
  "total_assets": "number or string",
  "total_liabilities": "number or string",
  "net_wealth": "number or string",
  "assets": [
    {
      "description": "string",
...
response = dashscope.MultiModalConversation.call(
    ...
    model="qwen3-vl-plus",  # In this example, qwen3-vl-plus is used. You can change the model name as needed. For a list of models, see https://www.alibabacloud.com/help/model-studio/getting-started/models.
    messages=messages)

#print(response["output"]["choices"][0]["message"].content[0]["text"])
output = response['output']['choices'][0]['message']['content'][0]['text']
# write the output to a file
with open('2_query_qwen/qwen_api_output3.json', 'w') as f:
    f.write(output)
